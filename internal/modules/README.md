...
| **🔨 infrastructure** | 基础设施 | 7 | 2 | K8s、ArgoCD、Nacos、Jira、SonarQube、Confluence |
| **💬 notification** | 消息通知 | 2 | 0 | Telegram Bot、模板渲染 |
...
- **审批流程**: 去 `approval/` 模块
- **K8s / ArgoCD / Nacos / Jira / SonarQube / Confluence**: 去 `infrastructure/` 模块
