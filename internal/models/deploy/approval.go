...
// 定义每个环境的默认审核行为（dev 宽松 / staging 中等 / prod 严格）
type EnvAuditPolicy struct {
	ID                   uint      `gorm:"primarykey" json:"id"`
	CreatedAt            time.Time `json:"created_at"`
	UpdatedAt            time.Time `json:"updated_at"`
	EnvName              string    `gorm:"size:50;uniqueIndex;not null" json:"env_name"`
	...
	RequireChain         bool      `gorm:"default:false" json:"require_chain"`
	DefaultChainID       *uint     `json:"default_chain_id"`
	RequireDeployWindow  bool      `gorm:"default:false" json:"require_deploy_window"`
	AutoRejectOutside    bool      `gorm:"default:false" json:"auto_reject_outside_window"`
	RequireCodeReview    bool      `gorm:"default:false" json:"require_code_review"`
	RequireTestPass      bool      `gorm:"default:false" json:"require_test_pass"`
	AllowEmergency       bool      `gorm:"default:true" json:"allow_emergency"`
	AllowRollback        bool      `gorm:"default:true" json:"allow_rollback"`
	MaxDeploysPerDay     int       `gorm:"default:0" json:"max_deploys_per_day"`
	Enabled              bool      `gorm:"default:true" json:"enabled"`
	CreatedBy            uint      `gorm:"default:0" json:"created_by"`
}

func (EnvAuditPolicy) TableName() string {
	return "env_audit_policies"
}
