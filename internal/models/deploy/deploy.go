...
type DeployRecord struct {
	...
	DeployMethod  string    `gorm:"size:50;default:'k8s'" json:"deploy_method"`     // 部署方式: k8s/gitops
	GitOpsChangeRequestID *uint `gorm:"index" json:"gitops_change_request_id"`      // GitOps 变更请求ID
