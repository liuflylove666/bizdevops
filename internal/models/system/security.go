...
type ImageRegistry struct {
	...
	Address   string    `gorm:"column:address;size:500" json:"-"`
...
type ImageScan struct {
	ID              uint       `gorm:"primaryKey" json:"id"`
	ImageName       string     `gorm:"column:image_name;size:300" json:"-"`
	ImageTag        string     `gorm:"column:image_tag;size:100" json:"-"`
	ScanStatus      string     `gorm:"column:scan_status;size:20" json:"-"`
	ApplicationID   *uint      `gorm:"index:idx_application" json:"application_id,omitempty"`
	ApplicationName string     `gorm:"size:200;index:idx_application_name" json:"application_name,omitempty"`
	PipelineRunID   *uint      `gorm:"index:idx_pipeline_run" json:"pipeline_run_id,omitempty"`
	...
	ScanResult      string     `gorm:"column:scan_result;type:longtext" json:"-"`
