...
import (
	...
	_ "devops/internal/modules/biz/handler"
	_ "devops/internal/modules/database/handler"
...
func main() {
	...
	// 种子注入 v2.0 Feature Flag（idempotent，保留人工调整）
	if err := feature.SeedV2Flags(context.Background(), db); err != nil {
		log.Warn("Failed to seed v2.0 feature flags: %v", err)
	}
