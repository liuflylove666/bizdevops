...
- **Database module** (`internal/service/database/`, `views/database/`): Phase 1–5 (ACL, execution records, tickets, rollback, Yearning SQL engine) are shipped. AI SQL is the only Phase still pending — verify before assuming it exists.
