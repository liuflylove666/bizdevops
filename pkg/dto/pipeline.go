...
type PipelineListRequest struct {
	...
	ApplicationName string `form:"application_name"`
	Env             string `form:"env"`
	Page            int    `form:"page"`
...
type PipelineItem struct {
	...
	CIEngine         string     `json:"ci_engine"`
...
type Step struct {
	ID         string                 `json:"id"`
	Name       string                 `json:"name"`
	Type       string                 `json:"type"` // git, docker_build, docker_push, shell, container, scan, notify
...
type PipelineRunItem struct {
	...
	GitOpsHandoffStatus   string     `json:"gitops_handoff_status,omitempty"`
	GitOpsHandoffMessage  string     `json:"gitops_handoff_message,omitempty"`
...
type PipelineRunDetailResponse struct {
	...
	ImageScan       *PipelineRunImageScan  `json:"image_scan,omitempty"`
	GitOpsHandoff   *PipelineRunGitOpsInfo `json:"gitops_handoff,omitempty"`
	StartedAt       *time.Time             `json:"started_at"`
	FinishedAt      *time.Time             `json:"finished_at"`
	Duration        int                    `json:"duration"`
	CreatedAt       time.Time              `json:"created_at"`
...
type PipelineRunImageScan struct {
...
type PipelineRunGitOpsInfo struct {
	Status              string `json:"status"`
	Message             string `json:"message"`
	ChangeRequestID     *uint  `json:"change_request_id,omitempty"`
	ChangeRequestTitle  string `json:"change_request_title,omitempty"`
