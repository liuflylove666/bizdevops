<template>
  <div class="instance-detail">
    ...
    <a-descriptions :column="2" bordered size="small">
      ...
      <a-descriptions-item label="交付记录ID">{{ instance.record_id }}</a-descriptions-item>
...
const loadUserList = async () => {
  try {
    ...
    const userData = res.data as PageResponse<User> | undefined
    userList.value = userData?.list || userData?.items || []
  } catch (error) {
