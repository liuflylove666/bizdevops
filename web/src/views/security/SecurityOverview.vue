<template>
  <div class="security-overview">
    ...
    <!-- Epic 6 / E6-02：安全域聚合入口（镜像 / 代码质量 / 供应链） -->
    <a-row :gutter="16" style="margin-top: 16px">
      <a-col :span="24">
        <a-card title="供应链与代码质量（聚合入口）">
          <a-typography-paragraph type="secondary" style="margin-bottom: 12px">
            将镜像仓库、Trivy 扫描、SonarQube 与 SBOM 合规串到同一视图；下方为快捷跳转。
          </a-typography-paragraph>
          <a-space wrap>
            <a-button type="primary" ghost @click="goToImageRegistry()">镜像仓库</a-button>
            <a-button ghost @click="goToImageScan()">镜像漏洞扫描</a-button>
            <a-button ghost @click="goToSonarQube()">SonarQube</a-button>
            <a-button disabled>SBOM 清单（规划中）</a-button>
          </a-space>
        </a-card>
      </a-col>
    </a-row>
...
const goToImageRegistry = () => router.push('/security/image-registry')
const goToSonarQube = () => router.push('/sonarqube')
