...
const resourceLabels: Record<string, string> = { k8s: 'K8s', k8s_resource: 'K8s资源', telegram: 'Telegram', oa: 'OA', user: '用户' }
const resourceColors: Record<string, string> = { k8s: 'purple', k8s_resource: 'geekblue', telegram: 'geekblue', oa: 'orange', user: 'magenta' }
