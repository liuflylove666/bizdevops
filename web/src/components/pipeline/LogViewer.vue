...
const connectWebSocket = () => {
  ...
  let url = `${protocol}//${host}/app/api/v1/pipelines/runs/${props.runId}/logs/stream`
  if (props.stepRunId) {
    url = `${protocol}//${host}/app/api/v1/pipelines/runs/${props.runId}/steps/${props.stepRunId}/logs/stream`
  }
...
const highlightKeyword = (line: string) => {
