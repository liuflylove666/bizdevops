        ...
        >
          <div class="stage-header">
            ...
            <a-dropdown>
              ...
              <template #overlay>
                <a-menu @click="onStageMenuClick($event, stageIndex)">
...
import {
  ...
  CodeOutlined, BellOutlined, CheckCircleOutlined
...
const onStageMenuClick = (info: MenuInfo, stageIndex: number) => {
  handleStageMenu(String(info.key), stageIndex)
}
